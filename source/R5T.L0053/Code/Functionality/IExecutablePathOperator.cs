...
namespace R5T.L0053
{
    ...
    {
        private static Implementations.IExecutablePathOperator Implementations => L0053.Implementations.ExecutablePathOperator.Instance;
        ...
        {
            var output = Implementations.Get_ExecutableFilePath_ViaCommandLineArgument();
            return output;
        }
