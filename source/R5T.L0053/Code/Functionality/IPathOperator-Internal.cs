...
namespace R5T.L0053.Internal
{
    ...
    public partial interface IPathOperator : IFunctionalityMarker
    {
        ...
        /// Unchecked in the sense that no check is done on whether the directory path is already directory indicated (see <see cref="L0053.IPathOperator.Ensure_DirectoryIndicated(string)"/>)
